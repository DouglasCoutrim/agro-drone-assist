...
import { 
  LayoutDashboard, FileText, Package, BarChart3, DollarSign, Settings, Users, Zap, CreditCard, MapPin
} from "lucide-react";
  ...
  return (
    <div className={cn("flex h-full w-64 flex-col bg-sidebar text-sidebar-foreground", className)}>
      <div className="flex items-center gap-3 border-b border-sidebar-border p-4">
        <img src={logo} alt="Volt Control" className="h-10 w-auto" />
        <div>
          <h2 className="text-lg font-bold text-primary">Volt Control</h2>
      ...
      <div className="border-t border-sidebar-border p-4">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-lg bg-primary/20"><Zap className="h-4 w-4 text-primary" /></div>
